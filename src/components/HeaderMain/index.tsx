    ...
    <View testID='header-main' style={styles.headerMain}>
        ...
        <View style={styles.headerOne}>
            ...
            <View style={styles.headerOneView}>
                <Text testID='place-text' style={{fontWeight:'600',fontSize:16}}>Home</Text>
                <Text style={{fontWeight:'500',fontSize:11.5,color:'#6E7480',marginLeft:6,marginRight:3}}>123 Main Street Anytown...</Text>
        ...
        <View style={styles.headerTwo}>
            ...
            <Text style={{fontSize:20,color:'#5D3EBD',fontWeight:'bold',textAlign:'center'}}>
                13<Text style={{fontSize:16,color:'#5D3EBD',fontWeight:'bold',textAlign:'center'}}>min</Text>
            </Text>
        </View>
